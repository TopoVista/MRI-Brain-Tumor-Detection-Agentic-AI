...
from app.workflows.orchestrator import run_analysis_workflow, stream_analysis_workflow
...
async def upload_mri_stream(file: UploadFile = File(...)) -> StreamingResponse:
    ...
    async def event_generator():
        try:
            async for event in stream_analysis_workflow(filename=file.filename or "scan.png", content=content):
