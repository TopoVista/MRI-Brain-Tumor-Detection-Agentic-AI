...
class Settings(BaseSettings):
    ...
    seed_knowledge_base_on_startup: bool = Field(default=False, alias="SEED_KNOWLEDGE_BASE_ON_STARTUP")
    cache_onnx_sessions: bool = Field(default=False, alias="CACHE_ONNX_SESSIONS")
