  ...
  return (
    <Card className="overflow-hidden">
      ...
      <CardContent className="space-y-5 p-5">
        <div className="rounded-[1.4rem] border border-slate-200 bg-[linear-gradient(180deg,#fbfeff,#f1f8fb)] p-4">
        ...
        <div className="grid gap-3">
          {checklist.map(({ label, detail, icon: Icon }) => (
            <div key={label} className="flex items-center gap-4 rounded-[1.2rem] border border-slate-200 bg-white px-4 py-3">
